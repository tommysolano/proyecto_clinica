 ...
 * Espejo de server/constants/specialtyCatalogs.js: las claves DEBEN coincidir,
 * porque el saneo del servidor valida contra ellas y una clave que no esté se
 * descarta al guardar.
 *
 *  · ORGANOS_NEUROFOCAL: el examen físico se llena ÓRGANO POR ÓRGANO — una
 ...
 *    cuadros de la fila (de muestra, no se pinchan) y al lado el texto de lo
 *    que se debe realizar en esa fila.
 */
export const ORGANOS_NEUROFOCAL = [
...
// hemiarco izquierdo.
export const ODONTO_NEUROFOCAL_FILAS = [
