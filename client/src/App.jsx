              ...
              <Routes>
                ...
                <Route
                  ...
                  element={
                    ...
                    <RoleRoute roles={['admin', 'cajero', 'call_center', 'marketing', 'enfermero', 'optica', 'odontologia', 'odontologia_neurofocal', 'terapeuta']}>
                      <Patients />
                    </RoleRoute>
                  }
                />
                ...
                />
                <Route
                  path="/commissions/:doctorId"
                  element={
                    <SuperAdminRoute>
                      <CommissionDoctorDetail />
                    </SuperAdminRoute>
                  }
                />
