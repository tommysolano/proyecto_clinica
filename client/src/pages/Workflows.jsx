...
const newStep = (type) => ({ type, body: '', templateName: '', templateLanguage: 'es', waitMinutes: 60, waitEvent: 'appointment_date', offsetMinutes: -1440, field: 'tag', op: 'eq', value: '', onFailGoTo: null, tag: '', stage: 'contactado' });
                    ...
                    <div key={idx} className="border border-slate-200 rounded-lg p-3">
                      ...
                      {(s.type === 'condition' || s.type === 'goal') && (
                        <div className="flex items-center gap-2 text-sm flex-wrap">
                          ...
                          {s.op !== 'exists' && s.field !== 'hasPatient' && (
