...
export default function Decimos() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2"><HiOutlineGift className="text-emerald-600" /> Plantillas de Décimos</h1>
      <div className="bg-white rounded-xl shadow-sm p-3 flex gap-2 items-center flex-wrap">
        ...
        <button onClick={generate} className="px-4 py-2 bg-emerald-600 text-white rounded-lg">Generar</button>
