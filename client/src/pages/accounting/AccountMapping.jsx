              ...
              {roles.filter((r) => r.group === g).map((r) => (
                <tr key={r.key} className="border-t">
                  ...
                  <td className="px-4 py-2">
                    <select value={draft[r.key] || ''} onChange={(e) => setDraft({ ...draft, [r.key]: e.target.value })} className="w-full max-w-md border border-slate-200 rounded-lg px-2 py-1.5 text-sm">
